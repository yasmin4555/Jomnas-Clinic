...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    name: "Angelo Rimmaudo",

    image:assets?.profile || "https://via.placeholder.com/150",
    email: "angel.rimmaudo122@gmail.com",
    phone: "+1 123 564 768",
    address: {
      line1: "5th cross, Sicily",
      line2: "Church road, Sicily",
    },
    gender: "Male",
    dob: "08-17-2000",
  });
...
<div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
  ...
  <p className="bg-text-blue-500">{userData.email}</p>
